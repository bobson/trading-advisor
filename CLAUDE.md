...
Forward roadmap (`trading-advisor-plan.md`) progress — **Phase 12 done** (`src/service/analyze.py`), **Phase 13 done** (`src/data/{base,crypto_ccxt,forex_api,registry,quality}.py`, `tests/test_data_provider.py`).
